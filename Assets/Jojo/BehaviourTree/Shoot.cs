    ...
    public class Shoot : AgentNode
    {
        ...
        public override bool execute()
        {
            if (agent.canShoot()) {
                ...
                GameObject temp = MonoBehaviour.Instantiate(Resources.Load("Bullet"), agent.transform.position + relativePosition.normalized * 10, Quaternion.identity) as GameObject;
